      ...
      <main className={`transition-all duration-1000 ${isOpened ? 'opacity-100' : 'opacity-0'}`}>
          ...
          >
            ...
            <div className="pt-[4vh] md:pt-16 pb-12">
                <div className="inline-block relative px-[6vw] md:px-12 py-[3vw] md:py-6 border-y border-[#D4AF37]/20">
                    <p className={`text-[4vw] md:text-3xl font-serif tracking-[0.4em] md:tracking-[0.6em] uppercase ${goldText} font-bold`}>{date.split(',')[0]}, {dayOfWeek}</p>
                </div>
            </div>
          </motion.div>
        </section>
        ...
        <section className="py-32 md:py-48 px-6 bg-white relative overflow-hidden">
           <div className="max-w-4xl mx-auto text-center space-y-20 relative z-10">
                       ...
                       <div className="flex justify-between items-end gap-2 pb-1 md:pb-2">
                          <div className="min-w-0 pr-1 md:pr-2">
                             <p className="text-[8px] md:text-[10px] font-bold tracking-[0.2em] md:tracking-[0.3em] text-[#D4AF37] uppercase mb-1 md:mb-2">
                               {isRussian ? "ВЛАДЕЛЕЦ КАРТЫ" : "KARTA EGASI"}
                             </p>
              ...
              <p className="text-lg text-gray-400 font-serif italic tracking-wide px-4">
        ...
        <footer className="py-32 md:py-48 px-6 bg-[#FAFAFA] text-center relative border-t border-[#D4AF37]/10">
          <div className="space-y-12">
            ...
            <div className="pt-24 border-t border-gray-100 max-w-lg mx-auto space-y-8">
              ...
              <div className="space-y-4">
                <p className="text-[10px] text-gray-600 uppercase tracking-[0.5em] text-center">
                  {isRussian ? "ИСПОЛЬЗОВАТЬ СЕРВИС:" : "Ximatdan foydalanish:"}
                </p>
                <a href="https://taklifnoma.asia" target="_blank" className="inline-block px-10 py-5 bg-[#B8962E] text-white rounded-full text-[11px] font-black tracking-widest uppercase shadow-lg hover:brightness-110 transition-all active:scale-95">
                  {isRussian ? "СОЗДАТЬ ПРИГЛАШЕНИЕ" : "TAKLIFNOMA YARATISH"}
                </a>
              </div>
            </div>
          </div>
